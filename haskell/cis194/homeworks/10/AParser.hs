...
instance Alternative Parser where
  ...
  p1 <|> p2 = Parser f where
    f str = runParser p1 str <|> runParser p2 str   -- use built-in one from Maybe

intOrUppercase :: Parser ()
intOrUppercase = const () <$> posInt <|> const () <$> satisfy isUpper


-- OK, I admit I learned the answer from someone else
-- But it does help me understand what Applicative functor does
